...
# xsys( "vcom -93 +acc -work work-msim  fir_synth_pkg.vhd fir.vhd fir_synth_pkg.vhd fir_tb.vhd")
xsys( "uw-msim-com  fir_synth_pkg.vhd fir.vhd fir_synth_pkg.vhd fir_tb.vhd")
